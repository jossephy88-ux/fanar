    ...
    with get_db() as db:
        ...
        if tipo == "motos":
            ...
            if dup:
                return jsonify({
                    "ok": False,
                    "error": f"La placa {placa} ya está registrada."
                })
...
def exportar(tipo):
    ...
    if tipo == "motos":
        ...
        headers = [
            "ID","Placa","Chasis","Cliente",
            "Cedula","Fecha","Observaciones","Registrado"
        ]

        cols = [
            "id","placa","chasis","cliente",
            "cedula","fecha","observaciones","creado"
        ]
        ...
        headers = [
            "ID","Placa","Chasis","Cliente",
            "Cedula","Fecha","Motor","Marca/Modelo",
            "Observaciones","Registrado"
        ]

        cols = [
            "id","placa","chasis","cliente",
            "cedula","fecha","motor","marca_modelo",
